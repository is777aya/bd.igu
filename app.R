  ...
  navbarPage(
    ...
    tabPanel("Mapa",
             div(class="outer",
                 ...
                 absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                               draggable = TRUE, top = 140, left = 20 , right = "auto", bottom = "auto",
...
cleantable_3 <- cleantable_3[order(cleantable_3$Produccion, decreasing = F) ,  ]
